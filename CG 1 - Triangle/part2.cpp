...
// Shader Functions- click on + to expand // FragColor = vec4(color.r,color.g,color.b,1.0);
...
GLuint generateObjectBuffer(GLfloat vertices[], GLfloat colors[]){
	...
	glBufferSubData (GL_ARRAY_BUFFER, numVertices*6*sizeof(GLfloat), numVertices*6*sizeof(GLfloat), colors);
return VBO;
}
...
void init()
{
	...
	GLfloat vertices[] = {-0.9f, -0.5f, 0.0f,-0.0f,-0.5f,0.0f,-0.45f,0.5f,0.0f,
