...
void main()                                                               \n\
{                                                                         \n\
	FragColor = vec4(1.0,0.11,0.68,1.0);					\n\
}";
...
GLuint CompileShaders(const char * pVS, const char * pFS2)
{
	...
	//AddShader1(shaderProgramID, pVS, GL_VERTEX_SHADER);
	//AddShader1(shaderProgramID, pFS1, GL_FRAGMENT_SHADER);
...
void init()
{
	...
	VAOs[0] = generateObjectBuffer(vertices, colors);
	linkCurrentBuffertoShader(shaderProgramID);
	glDrawArrays(GL_TRIANGLES, 0, 3);
	
	glBindVertexArray(VAOs[1]);
	VAOs[1] = generateObjectBuffer(vertices2, colors);
	linkCurrentBuffertoShader(shaderProgramID);
	glDrawArrays(GL_TRIANGLES, 0, 3);
